...
(`element_config.json`, `grid.csv`, `core_model.json`, and this level's
`atomic_core_*.csv`) are placed in one directory; your code is given the config
and grid paths and should read the rest relative to the config.
