...
All four difficulty levels, generated by `../reference/build_harbor.py` (the
...
- `qp-eft-L4-frontier/` — open frontier: no formula, no atomic data; the agent
  computes its own atomic inputs and may go beyond the published leading order.
...
python3 reference/build_harbor.py                          # assemble all four Harbor tasks
```
